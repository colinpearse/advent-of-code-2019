...
class IntBox:
    ...
    # returns: code,output (code==0 means run has terminated)
    def run(self, I):
        self.__O = []
        Ii = 0
        while True:
            ...
            if opcode == 1:
                ...
                if Ii < len(I):
                    ...
                    return self.__i, self.__O  # no input: freeze ops for this object by returning output
                self.__i += 2
            elif opcode == 4:
